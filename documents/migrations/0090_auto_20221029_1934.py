    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_title', wagtail.fields.RichTextField(blank=True)),
                ('source', wagtail.fields.RichTextField(blank=True, null=True)),
                ('transcription', wagtail.fields.StreamField([('transcription_row', wagtail.blocks.StructBlock([('transcription_text', wagtail.blocks.RichTextBlock(features=['h1', 'h2', 'h3', 'h4', 'bold', 'italic', 'underline', 'strikethrough', 'small', 'red', 'blue', 'green', 'blockquote', 'blockindent', 'doubleindent', 'superscript', 'subscript', 'ul', 'image', 'link', 'hr', 'embed'])), ('source_image', wagtail.images.blocks.ImageChooserBlock(help_text='Source image', required=False))], icon='edit'))], blank=True, null=True)),
                ('commentary', wagtail.fields.StreamField([('richtext', wagtail.blocks.RichTextBlock(features=['h1', 'h2', 'h3', 'h4', 'bold', 'italic', 'underline', 'strikethrough', 'small', 'red', 'blue', 'green', 'blockquote', 'blockindent', 'doubleindent', 'superscript', 'subscript', 'ul', 'image', 'link', 'hr', 'embed'], template='streams/richtext_block.html'))], blank=True, null=True)),
